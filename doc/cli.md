...
+--------------+-----------------------+-----------------------+------------+
| Block        | Address Range         | Used/Alloc            | Efficiency |
+===============================================================================+
| block        | 0x0008B000-0x0008BFFF | 308 bytes/4,096 bytes | 7.5%       |
|--------------+-----------------------+-----------------------+------------|
| block2       | 0x0008C000-0x0008CFFF | 80 bytes/4,096 bytes  | 2.0%       |
|--------------+-----------------------+-----------------------+------------|
| block3       | 0x0008D000-0x0008DFFF | 160 bytes/4,096 bytes | 3.9%       |
|--------------+-----------------------+-----------------------+------------|
| block_bitmap | 0x0008E000-0x0008E0FF | 19 bytes/256 bytes    | 7.4%       |
|--------------+-----------------------+-----------------------+------------|
| simple_block | 0x00008000-0x000080FF | 49 bytes/256 bytes    | 19.1%      |
|--------------+-----------------------+-----------------------+------------|
| pg_block     | 0x00001000-0x000010FF | 11 bytes/256 bytes    | 4.3%       |
+--------------+-----------------------+-----------------------+------------+
```
