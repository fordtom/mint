...
"#;
    ...
    commands::build(&args_be_hex, ds.as_ref()).expect("be-hex");
    ...
    commands::build(&args_be_mot, ds.as_ref()).expect("be-mot");
    ...
    commands::build(&args_le_hex, ds.as_ref()).expect("le-hex");
    ...
    commands::build(&args_le_mot, ds.as_ref()).expect("le-mot");
